              ...
              <motion.button
                ...
                className={cn(
                  ...
                  selectedCompany?.id === company.id
                    ...
                    : "bg-white border-slate-100 text-slate-600 hover:border-sky-200 hover:shadow-lg shadow-slate-200/50"
                )}
              >
                <div className={cn(
                  "w-14 h-14 rounded-2xl flex items-center justify-center font-bold text-xl shrink-0 overflow-hidden border-2",
                  selectedCompany?.id === company.id ? "bg-white/20 border-white/20 text-white" : "bg-sky-50 border-white text-sky-600"
                )}>
                  {company.avatar_url ? (
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {company.verified && <ShieldCheck size={14} className={cn(selectedCompany?.id === company.id ? "text-white" : "text-sky-500")} />}
                  </div>
              ...
              >
                ...
                <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm relative overflow-hidden">
                  ...
                  <div className="relative flex flex-col md:flex-row items-start md:items-center gap-8 mb-10">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-6 mt-4 text-sm font-bold">
                        <span className="flex items-center gap-2 text-slate-500"><MapPin size={16} className="text-sky-500" /> {selectedCompany.location || 'N/A'}</span>
                        <a href={selectedCompany.website} target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sky-600 hover:text-sky-700 underline underline-offset-4">
                  ...
                  <div className="prose prose-slate max-w-none">
                    <h4 className="text-xs font-black text-sky-600 uppercase tracking-widest mb-3">Vision & Mission</h4>
